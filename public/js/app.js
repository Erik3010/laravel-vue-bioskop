...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/Branch.vue?vue&type=script&lang=js&":
/*!*****************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/Branch.vue?vue&type=script&lang=js& ***!
  \*****************************************************************************************************************************************************************/
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    'app-header': _Header_vue__WEBPACK_IMPORTED_MODULE_1__["default"]
  },
  data: function data() {
    return {
      branches: [],
  ...
  methods: {
    fetchBranch: function fetchBranch() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.get('/api/v1/branches').then(function (res) {
        // console.log(res.data.data)
        _this.branches = res.data.data;
      })["catch"](function (err) {
        console.log(function (err) {// console.log(err);
        });
      });
    },
    inputBranch: function inputBranch() {
      var _this2 = this;

      axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/api/v1/branches', this.branch).then(function (res) {
        // console.log(res)
        _this2.fetchBranch();
    ...
    updateBranch: function updateBranch() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.put('/api/v1/branches/' + id, this.branch).then(function (res) {
        _this3.fetchBranch();

        _this3.is_edit = 0;
        _this3.branch.name = ''; // console.log(res)
      })["catch"](function (err) {// console.log(err)
      });
    },
    deleteBranch: function deleteBranch(id) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a["delete"]('/api/v1/branches/' + id).then(function (res) {
        // console.log(res)
        _this4.fetchBranch();
      })["catch"](function (err) {// console.log(err)
      });
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    login: function login() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/api/v1/auth/login', this.data).then(function (res) {
        // console.log(res)
        var token = res.data.token;
        var role = res.data.role; // console.log(token)
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    fetchMovie: function fetchMovie() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.get('/api/v1/movies?token=' + token).then(function (res) {
        _this.movies = res.data.data; // console.log(this.movies)
      })["catch"](function (err) {
        console.log(err);
      });
    },
    createMovie: function createMovie() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/api/v1/movies?token=' + token, formData).then(function (res) {
        // console.log(res)
        _this2.fetchMovie();
      })["catch"](function (err) {
        console.log(err);
    ...
    updateMovie: function updateMovie() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/api/v1/movies/' + id + '?token=' + token, formData).then(function (res) {
        console.log(res);
    ...
    deleteMovie: function deleteMovie(id) {
      ...
      var token = localStorage.getItem('token');
      axios__WEBPACK_IMPORTED_MODULE_0___default.a["delete"]('api/v1/movies/' + id).then(function (res) {
        // console.log(res)
        _this4.fetchMovie();
      })["catch"](function (err) {// console.log(err)
      });
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    fetchSchedule: function fetchSchedule() {
      ...
      var token = localStorage.getItem('token');
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.get('api/v1/schedules?token=' + token).then(function (res) {
        _this.schedules = res.data.data; // console.log(this.schedules);
      })["catch"](function (err) {
        console.log(err);
      });
    },
    createSchedule: function createSchedule() {
      ...
      var token = localStorage.getItem('token');
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('api/v1/schedules?token=' + token, this.schedule).then(function (res) {
        // console.log(res)
    ...
    updateSchedule: function updateSchedule() {
      ...
      var token = localStorage.getItem('token');
      var id = localStorage.getItem('id');
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.put('/api/v1/schedules/' + id + '?token=' + token, this.schedule).then(function (res) {
        console.log(res);
    ...
    deleteSchedule: function deleteSchedule(id) {
      ...
      var token = localStorage.getItem('token');
      axios__WEBPACK_IMPORTED_MODULE_0___default.a["delete"]('/api/v1/schedules/' + id).then(function (res) {
        // console.log(res);
...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/Studio.vue?vue&type=script&lang=js&":
/*!*****************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/Studio.vue?vue&type=script&lang=js& ***!
  \*****************************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    fetchStudio: function fetchStudio() {
      var _this = this;

      var token = localStorage.getItem('token');
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.get('/api/v1/studios?token=' + token).then(function (res) {
        // console.log(res)
        _this.studios = res.data.data;
      })["catch"](function (err) {// console.log(err)
      });
    },
    inputStudio: function inputStudio() {
      var _this2 = this;

      axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/api/v1/studios', this.studio).then(function (res) {
        // console.log(res)
        _this2.fetchStudio();
      })["catch"](function (err) {// console.log(err)
      });
    },
    editStudio: function editStudio(id) {
      localStorage.setItem('id', id);
      this.is_edit = 1;
    },
    updateStudio: function updateStudio() {
      var _this3 = this;

      var id = localStorage.getItem('id', id);
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.put('/api/v1/studios/' + id, this.studio).then(function (res) {
        console.log(res);
    ...
    deleteStudio: function deleteStudio(id) {
      var _this4 = this;

      axios__WEBPACK_IMPORTED_MODULE_0___default.a["delete"]('/api/v1/studios/' + id).then(function (res) {
        // console.log(res)
        _this4.fetchStudio();
      })["catch"](function (err) {// console.log(err)
      });
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/Branch.vue?vue&type=template&id=69b19a66&":
/*!*********************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/Branch.vue?vue&type=template&id=69b19a66& ***!
  \*********************************************************************************************************************************************************************************************************/
    ...
    [
      ...
      _c(
        ...
        [
          _vm._m(0),
          _vm._v(" "),
          _vm._l(_vm.branches, function(b, index) {
            ...
            _c(
              ...
              [
                _c("router-link", { attrs: { to: "/", tag: "li" } }, [
                  _c("a", { staticClass: "nav-link" }, [_vm._v("Branch")])
                ]),
                _vm._v(" "),
                _c("router-link", { attrs: { to: "/studio", tag: "li" } }, [
                  _c("a", { staticClass: "nav-link" }, [_vm._v("Studio")])
                ]),
                _vm._v(" "),
                _c("router-link", { attrs: { to: "/movie", tag: "li" } }, [
                  _c("a", { staticClass: "nav-link" }, [_vm._v("Movie")])
                ]),
                _vm._v(" "),
                _c("router-link", { attrs: { to: "/schedule", tag: "li" } }, [
...
var render = function() {
  ...
  return _c("div", { staticClass: "jumbotron" }, [
    _c("form", [
      ...
      _vm._v(" "),
      _c("input", {
        staticClass: "btn btn-primary col-sm-12",
      ...
      _c("div", [
        _c("form", [
          _c("div", { staticClass: "form-group" }, [
            _c("label", { attrs: { for: "name" } }, [_vm._v("Movie Name")]),
            _vm._v(" "),
            _c("input", {
              directives: [
                {
          ...
          _vm._v(" "),
          _c("div", { staticClass: "form-group" }, [
            _c("label", { attrs: { for: "minute" } }, [
              _vm._v("Minute length")
            ]),
            _vm._v(" "),
            _c("input", {
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.movie.minute_length,
                  expression: "movie.minute_length"
                }
              ],
              staticClass: "form-control",
              attrs: { type: "text", id: "minute" },
              domProps: { value: _vm.movie.minute_length },
              on: {
                input: function($event) {
                  if ($event.target.composing) {
                    return
                  }
                  _vm.$set(_vm.movie, "minute_length", $event.target.value)
                }
              }
            })
          ]),
          ...
          _c(
            ...
            _vm._l(_vm.movies, function(movie, index) {
              return _c("tr", { key: movie.id }, [
                ...
                _vm._v(" "),
                _c("td", [_vm._v(_vm._s(movie.minute_length) + " minutes ")]),
                _vm._v(" "),
                _c("td", [
                  _c("img", {
...
var staticRenderFns = [
  function() {
    ...
    return _c("thead", { staticClass: "thead-dark" }, [
      _c("th", [_vm._v("No")]),
      _vm._v(" "),
      _c("th", [_vm._v("Movie Name")]),
      _vm._v(" "),
      _c("th", [_vm._v("Minute Length")]),
      _vm._v(" "),
  ...
  return _c(
    ...
    [
      ...
      _c("div", [
        _c("form", [
          _c("div", { staticClass: "form-group" }, [
            _c("label", { attrs: { for: "movieID" } }, [_vm._v("Movie ID")]),
            _vm._v(" "),
            _c("input", {
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.schedule.movie_id,
                  expression: "schedule.movie_id"
                }
              ],
              staticClass: "form-control",
              attrs: { type: "text", id: "movieID" },
              domProps: { value: _vm.schedule.movie_id },
              on: {
                input: function($event) {
                  if ($event.target.composing) {
                    return
                  }
                  _vm.$set(_vm.schedule, "movie_id", $event.target.value)
                }
              }
            }),
            _vm._v(" "),
            _c("label", { attrs: { for: "studioID" } }, [_vm._v("Studio ID")]),
            _vm._v(" "),
            _c("input", {
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.schedule.studio_id,
                  expression: "schedule.studio_id"
                }
              ],
              staticClass: "form-control",
              attrs: { type: "text", id: "studioID" },
              domProps: { value: _vm.schedule.studio_id },
              on: {
                input: function($event) {
                  if ($event.target.composing) {
                    return
                  }
                  _vm.$set(_vm.schedule, "studio_id", $event.target.value)
                }
              }
            }),
            _vm._v(" "),
              ...
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.schedule.start,
                  expression: "schedule.start"
                }
              ],
              staticClass: "form-control",
              attrs: { type: "text", id: "startTime" },
              domProps: { value: _vm.schedule.start },
              on: {
                input: function($event) {
                  if ($event.target.composing) {
                    return
                  }
                  _vm.$set(_vm.schedule, "start", $event.target.value)
                }
              }
            })
          ]),
          ...
          _c(
            ...
            _vm._l(_vm.schedules, function(schedule, index) {
              return _c("tr", { key: index }, [
                _c("td", [_vm._v(_vm._s(index + 1))]),
                _vm._v(" "),
                _c("td", [_vm._v(_vm._s(schedule.movie_id))]),
                _vm._v(" "),
                _c("td", [_vm._v(_vm._s(schedule.studio_id))]),
                _vm._v(" "),
                _c("td", [_vm._v(_vm._s(schedule.start))]),
                _vm._v(" "),
                _c("td", [_vm._v(_vm._s(schedule.end))]),
                _vm._v(" "),
                _c("td", [_vm._v(_vm._s(schedule.price))]),
                _vm._v(" "),
                _c("td", [
                  _c(
                    "button",
...
var staticRenderFns = [
  function() {
    ...
    return _c("thead", { staticClass: "thead-dark" }, [
      _c("th", [_vm._v("No")]),
      _vm._v(" "),
      _c("th", [_vm._v("Movie ID")]),
      _vm._v(" "),
      _c("th", [_vm._v("Studio ID")]),
      _vm._v(" "),
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/Studio.vue?vue&type=template&id=43c97d01&":
/*!*********************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/Studio.vue?vue&type=template&id=43c97d01& ***!
  \*********************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
  ...
  return _c(
    ...
    [
      ...
      _c("input", {
        ...
        attrs: { name: "text" },
        domProps: { value: _vm.studio.name },
        on: {
          input: function($event) {
            if ($event.target.composing) {
              return
            }
            _vm.$set(_vm.studio, "name", $event.target.value)
          }
        }
      }),
      _vm._v(" "),
        ...
        directives: [
          {
            name: "model",
            rawName: "v-model",
            value: _vm.studio.branch_id,
            expression: "studio.branch_id"
          }
        ],
        attrs: { name: "text" },
        domProps: { value: _vm.studio.branch_id },
        on: {
          input: function($event) {
            if ($event.target.composing) {
              return
            }
            _vm.$set(_vm.studio, "branch_id", $event.target.value)
          }
        }
      }),
      _vm._v(" "),
        ...
        directives: [
          {
            name: "model",
            rawName: "v-model",
            value: _vm.studio.basic_price,
            expression: "studio.basic_price"
          }
        ],
        attrs: { name: "text" },
        domProps: { value: _vm.studio.basic_price },
        on: {
          input: function($event) {
            if ($event.target.composing) {
              return
            }
            _vm.$set(_vm.studio, "basic_price", $event.target.value)
          }
        }
      }),
      _vm._v(" "),
        ...
        directives: [
          {
            name: "model",
            rawName: "v-model",
            value: _vm.studio.additional_friday_price,
            expression: "studio.additional_friday_price"
          }
        ],
        attrs: { name: "text" },
        domProps: { value: _vm.studio.additional_friday_price },
        on: {
          input: function($event) {
            if ($event.target.composing) {
              return
            }
            _vm.$set(_vm.studio, "additional_friday_price", $event.target.value)
          }
        }
      }),
      _vm._v(" "),
        ...
        directives: [
          {
            name: "model",
            rawName: "v-model",
            value: _vm.studio.additional_saturday_price,
            expression: "studio.additional_saturday_price"
          }
        ],
        attrs: { name: "text" },
        domProps: { value: _vm.studio.additional_saturday_price },
        on: {
          input: function($event) {
            if ($event.target.composing) {
              return
        ...
        directives: [
          {
            name: "model",
            rawName: "v-model",
            value: _vm.studio.additional_sunday_price,
            expression: "studio.additional_sunday_price"
          }
        ],
        attrs: { name: "text" },
        domProps: { value: _vm.studio.additional_sunday_price },
        on: {
          input: function($event) {
            if ($event.target.composing) {
              return
            }
            _vm.$set(_vm.studio, "additional_sunday_price", $event.target.value)
          }
        }
      }),
      _vm._v(" "),
      ...
      _c(
        ...
        [
          _vm._m(0),
          _vm._v(" "),
          _vm._l(_vm.studios, function(studio, index) {
            return _c("tr", { key: studio.id }, [
              _c("td", [_vm._v(_vm._s(index + 1))]),
              _vm._v(" "),
              _c("td", [_vm._v(_vm._s(studio.name))]),
              _vm._v(" "),
              _c("td", [_vm._v(_vm._s(studio.branch_name))]),
              _vm._v(" "),
              _c("td", [_vm._v(_vm._s(studio.basic_price))]),
              _vm._v(" "),
              _c("td", [_vm._v(_vm._s(studio.additional_friday_price))]),
              _vm._v(" "),
              _c("td", [_vm._v(_vm._s(studio.additional_saturday_price))]),
              _vm._v(" "),
              _c("td", [_vm._v(_vm._s(studio.additional_sunday_price))]),
              _vm._v(" "),
              _c("td", [
                _c(
                  "button",
                  {
                    ...
                    on: {
                      click: function($event) {
                        return _vm.editStudio(studio.id)
                      }
                    }
                  },
                  [_vm._v("Edit")]
                ...
                _c(
                  "button",
                  {
                    ...
                    on: {
                      click: function($event) {
                        return _vm.deleteStudio(studio.id)
                      }
                    }
                  },
                  [_vm._v("Delete")]
...
var staticRenderFns = [
  function() {
    ...
    return _c("tr", [
      ...
      _c("th", [_vm._v("Name")]),
      _vm._v(" "),
      _c("th", [_vm._v("Branch ID")]),
      _vm._v(" "),
      _c("th", [_vm._v("Basic Price")]),
      _vm._v(" "),
      _c("th", [_vm._v("Additional Friday Price")]),
      _vm._v(" "),
      _c("th", [_vm._v("Additional Saturday Price")]),
      _vm._v(" "),
      _c("th", [_vm._v("Additional Sunday Price")]),
      _vm._v(" "),
      _c("th", [_vm._v("Action")])
    ])
  }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Branch_vue_vue_type_template_id_69b19a66___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../node_modules/vue-loader/lib??vue-loader-options!./Branch.vue?vue&type=template&id=69b19a66& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/Branch.vue?vue&type=template&id=69b19a66&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Branch_vue_vue_type_template_id_69b19a66___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Branch_vue_vue_type_template_id_69b19a66___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
...
/***/ "./resources/js/components/Studio.vue":
/*!********************************************!*\
  !*** ./resources/js/components/Studio.vue ***!
  \********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Studio_vue_vue_type_template_id_43c97d01___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Studio.vue?vue&type=template&id=43c97d01& */ "./resources/js/components/Studio.vue?vue&type=template&id=43c97d01&");
/* harmony import */ var _Studio_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Studio.vue?vue&type=script&lang=js& */ "./resources/js/components/Studio.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport *//* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  ...
  _Studio_vue_vue_type_template_id_43c97d01___WEBPACK_IMPORTED_MODULE_0__["render"],
  _Studio_vue_vue_type_template_id_43c97d01___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/Studio.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/js/components/Studio.vue?vue&type=script&lang=js&":
/*!*********************************************************************!*\
  !*** ./resources/js/components/Studio.vue?vue&type=script&lang=js& ***!
  \*********************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Studio_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/babel-loader/lib??ref--4-0!../../../node_modules/vue-loader/lib??vue-loader-options!./Studio.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/Studio.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport */ /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Studio_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./resources/js/components/Studio.vue?vue&type=template&id=43c97d01&":
/*!***************************************************************************!*\
  !*** ./resources/js/components/Studio.vue?vue&type=template&id=43c97d01& ***!
  \***************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Studio_vue_vue_type_template_id_43c97d01___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../node_modules/vue-loader/lib??vue-loader-options!./Studio.vue?vue&type=template&id=43c97d01& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/Studio.vue?vue&type=template&id=43c97d01&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Studio_vue_vue_type_template_id_43c97d01___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Studio_vue_vue_type_template_id_43c97d01___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
...
/* harmony import */ var _components_Branch_vue__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/Branch.vue */ "./resources/js/components/Branch.vue");
...
/* harmony import */ var _components_Studio_vue__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/Studio.vue */ "./resources/js/components/Studio.vue");
/* harmony import */ var _components_Movie_vue__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/Movie.vue */ "./resources/js/components/Movie.vue");
/* harmony import */ var _components_Schedule_vue__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/Schedule.vue */ "./resources/js/components/Schedule.vue");
...
var routes = [{
  path: '/',
  component: _components_Branch_vue__WEBPACK_IMPORTED_MODULE_2__["default"]
}, {
  path: '/login',
  component: _components_Login_vue__WEBPACK_IMPORTED_MODULE_3__["default"]
}, {
  path: '/studio',
  component: _components_Studio_vue__WEBPACK_IMPORTED_MODULE_4__["default"]
}, {
  path: '/movie',
  component: _components_Movie_vue__WEBPACK_IMPORTED_MODULE_5__["default"]
}, {
  path: '/schedule',
  component: _components_Schedule_vue__WEBPACK_IMPORTED_MODULE_6__["default"]
}];
...
__webpack_require__(/*! D:\Kelas 11\Administrasi Sistem Jaringan\Laravel\laravelVueBioskop\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! D:\Kelas 11\Administrasi Sistem Jaringan\Laravel\laravelVueBioskop\resources\sass\app.scss */"./resources/sass/app.scss");
